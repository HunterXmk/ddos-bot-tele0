...
bot_token = '6481506734:AAFIxjiNIALDFJhWKAR8R3XSiNm7obJP2NQ'

bot = telebot.TeleBot(bot_token)

allowed_group_id = -4021286976
...
def attack_command(message):
    ...
    blocked_numbers = ['113', '114', '115', '198', '911', '0373901952']
...
def send_admin_link(message):
    bot.reply_to(message, "Telegram: t.me/death_noname")
@bot.message_handler(commands=['sms'])
def sms(message):
    pass
